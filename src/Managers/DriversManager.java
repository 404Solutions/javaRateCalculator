...
public class DriversManager {
    ...
    public PrimaryDriver insertPrimaryDriver(int userId, String firstName, String lastName, Date dateOfBirth, String address, String city,
    ...
    public SecondaryDriver insertSecondaryDriver(int userId, String firstName, String lastName, Date dateOfBirth, String address, String city,
                                               String province, String postalCode, String phoneNumber, String email, String gender,
                                               String driversLicenceNumber, Date licenseDateIssued) throws SQLException {
        ...
        try {
            ...
            driver = new SecondaryDriver(userId, firstName, lastName, dateOfBirth, address, city,
                    province, postalCode, phoneNumber, email, gender,
                    driversLicenceNumber, licenseDateIssued);
