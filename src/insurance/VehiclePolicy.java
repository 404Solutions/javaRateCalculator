...
public class VehiclePolicy extends Policy {
    ...
    public VehiclePolicy(String policyID, User user, Quote quote, String startDate, String endDate, double basePremium, double tax, double total, Vehicle vehicle, double replacementCosts) {
